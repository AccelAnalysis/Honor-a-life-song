...
export const workspaceNavigation: Record<WorkspaceId, NavigationItem[]> = {
  ...
  admin: [
    ...
    { id: "people", label: "Users & Organizations", slug: "people", description: "Manage customers, families, facilities, creators, partners, and sponsors.", availability: "structured", unavailableReason: structured },
    ...
    { id: "consent", label: "Consent & Compliance", slug: "consent", description: "Manage permissions, restrictions, withdrawals, retention, and audit history.", availability: "structured", unavailableReason: structured },
