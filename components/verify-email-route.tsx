...
export function VerifyEmailRoute() {
  ...
  if (status === "signed_out" || !user) return <main className="centeredPage"><section className="authCard"><h1>Sign in to verify your email.</h1><Link href="/login?next=%2Fverify-email">Sign in</Link></section></main>;
  ...
  return <main className="centeredPage"><section className="authCard">
    ...
    <Link href="/organization">Continue to account</Link>
  </section></main>;
}
